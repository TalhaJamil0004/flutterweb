...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> launchWhatsApp() async {
    const phoneNumber = '+923256333353'; // Replace with your WhatsApp number
    const url = 'https://wa.me/$phoneNumber?app_absent=1'; // Use final for the dynamic string
    ...
    return Scaffold(
      appBar: AppBar(
       ...
       floatingActionButton: FloatingActionButton(
        onPressed: () async {
          const phoneNumber = '+923241113337'; // Replace with your WhatsApp number
          const url = 'https://wa.me/$phoneNumber?app_absent=1';
          if (await canLaunch(url)) {
            await launch(url);
          } else {
            throw 'Could not launch $url';
